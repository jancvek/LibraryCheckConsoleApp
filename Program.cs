...
namespace LibraryCheckConsoleApp
{
    class Program
    {
        ...
        public static void CheckLibrary(LibraryUser userData)
        {
            ...
            IWebElement memberIdField = Driver.FindElement(By.Id("libMemberID"));
            memberIdField.SendKeys(userData.MemberId);  // 0104232

            IWebElement passwordField = Driver.FindElement(By.Id("password1"));
            passwordField.SendKeys(userData.Password);   // knjiga

            IWebElement submitButton = Driver.FindElement(By.Id("wp-submit1"));
            submitButton.Click();
            ...
            Driver.Url = "https://plus.si.cobiss.net/opac7/mylib/" + loanLink + "/loan";
